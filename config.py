...
JARUJARU_TOWER_PLAYLISTS = {
  ...
  "PLRdiaanKAFQmfcVpdsVLoQUpdtSNojOKK": {"title": "【作業用ネタ】耳でジャルジャルを楽しむ奴","total_results": 55},
  "PLRdiaanKAFQmsC6fP_St6EgaSMeOMDGOS": {"title": "【入門編】ジャルジャルに興味湧いてきた奴","total_results": 20},
